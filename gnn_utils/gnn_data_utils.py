...
class GnnDataUtils:
    ...
    @classmethod
    def _node_features_from_atom(cls, atom, predict_type) -> [int]:
        """ 获得原子的特征
    ...
    @classmethod
    def nodes_features_from_mol(cls, mol, predict_type: str, no_h: bool = False) -> [[int]]:
        """ 获得所有原子的特征
        ...
        if not no_h:
            ...
            for atom in mol.GetAtoms():
                features.append((atom.GetIdx(), cls._node_features_from_atom(atom, predict_type)))
            ...
            for atom in mol.GetAtoms():
                ...
                now_aid += 1
                features.append(cls._node_features_from_atom(atom, predict_type))
    ...
    @classmethod
    def gnn_data_from_inchi(cls, inchi: str):
